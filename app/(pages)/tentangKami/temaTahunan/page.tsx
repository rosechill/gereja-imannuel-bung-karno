  ...
  return (
    <section className="py-desktop flex flex-col justify-center gap-8 mt-20">
      <div className={rightous.className}>
        <h1 className="text-3xl text-center">TEMA TAHUNAN GPIB</h1>
      </div>
      <div className={rightous.className}>
        <div className="w-3/4 m-0-auto">
          <h1 className="text-2xl ">TEMA SENTRAL (JANGKA PANJANG) UNTUK 2006 – 2026</h1>
        </div>
      </div>
      ...
      <div className={rightous.className}>
        <div className="w-3/4 m-0-auto">
          <h1 className="text-2xl ">Tema PKUPPG Jangka Pendek IV Tahun 2022 - 2026</h1>
        </div>
      </div>
      <div className={arsenal.className}>
        <div className="w-3/4 m-0-auto">
      ...
      <div className={rightous.className}>
        <div className="w-3/4 m-0-auto">
          <h1 className="text-2xl ">Tema Tahunan GPIB Tahun 2024 - 2025</h1>
        </div>
      </div>
      <div className={arsenal.className}>
        <div className="w-3/4 m-0-auto">
      ...
      <div className={rightous.className}>
        <div className="w-3/4 m-0-auto">
          <h1 className="text-2xl ">Tema 5 Tahun</h1>
        </div>
      </div>
      <div className={arsenal.className}>
        <div className="w-3/4 m-0-auto">
      ...
      <div className={rightous.className}>
        <div className="w-3/4 m-0-auto">
          <h1 className="text-2xl ">TEMA 2018/2019</h1>
        </div>
      </div>
      <div className={arsenal.className}>
        <div className="w-3/4 m-0-auto">
