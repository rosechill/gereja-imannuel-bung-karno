      ...
      <div className={arsenal.className}>
        <div className="desktop:w-3/4 w-full m-0-auto desktop:px-0 px-4">
          <p>
            ...
            bertujuan untuk menyediakan tempat ibadah yang layak bagi umat Kristen Protestan di wilayah tersebut.
          </p>
        </div>
      </div>
      <div className={rightous.className}>
      ...
      <div className={arsenal.className}>
        <div className="desktop:w-3/4 w-full m-0-auto desktop:px-0 px-4">
          <p>
            ...
            Thomas Matulesti, dan Bapak Luhulima. Peresmian gereja ini merupakan tonggak penting dalam sejarah
            pengembangan pelayanan keagamaan di Mataram dan sekitarnya.
          </p>
        </div>
      </div>
      <div className={rightous.className}>
      ...
      <div className={arsenal.className}>
        <div className="desktop:w-3/4 w-full m-0-auto desktop:px-0 px-4">
          <p>
            ...
            serta PHMJ 11 personil serta unit misioner lainnya. Pelembagaan resmi dilaksanakan pada ibadah Minggu, 15
            Maret 2015, yang dipimpin oleh fungsionaris majelis sinode GPIB.
          </p>
        </div>
      </div>
      <div className={rightous.className}>
      ...
      <div className={arsenal.className}>
        <div className="desktop:w-3/4 w-full m-0-auto desktop:px-0 px-4">
          <p>
            ...
            dan berbagai kegiatan pendukung, termasuk pendidikan agama dan pelayanan sosial. Bangunan gereja terus
            dirawat dan diperbarui untuk memenuhi kebutuhan jemaat dan mempertahankan nilai historisnya.
          </p>
        </div>
      </div>
    </section>
